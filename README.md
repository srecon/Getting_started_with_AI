...
|------------------------------------------------------------------------------------------|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Chapter 1. Getting started with Local LLM                                                | [./chapter-1](./chapter-1) | - [ollama_inference.md](chapter-1/ollama_inference.md)<br/>- [Configure_env.md](chapter-1/Configure_env.md)<br/>- [install_Jupyter.md](chapter-1/install_Jupyter.md)<br/>- [TokenaizationAndEmbedding.ipynb](chapter-1/TokenaizationAndEmbedding.ipynb)                   |
